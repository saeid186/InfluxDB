...
def config_logger():
    ...
    try:
        ...
        print
        "log_max_size needs to be an integer"
        sys.exit(1)
    try:
        cfg['fluxios']['log_keep'] = int(cfg['fluxios']['log_keep'])
    except ValueError:
        print
        "log_keep needs to be an integer"
        sys.exit(1)
    ...
    try:
        ...
        print
        "IOError while configuring RotatingFileHandler: {0}".format(e)
        sys.exit(1)
...
def sighandler(signum, frame):
    ...
    print
    "Received {0}, going to shutdown...".format(SIGNALS_TO_NAMES_DICT[signum])
